                                ...
                                <div className="markdown-content">
                                    <ReactMarkdown
                                        ...
                                        components={{
                                            ...
                                            h2: ({node, ...props}) => <h2 className="text-base font-bold mb-2 text-indigo-800" {...props} />,
                                            h3: ({node, ...props}) => <h3 className="text-sm font-bold mb-1 text-indigo-700" {...props} />,
                                            strong: ({node, ...props}) => <strong className="font-bold text-indigo-900" {...props} />,
                                            code: ({node, inline, className, children, ...props}: any) => {
                                                return inline ? (
                                                    <code className="bg-indigo-50 text-indigo-600 px-1 py-0.5 rounded text-xs font-mono border border-indigo-100" {...props}>{children}</code>
                                                ) : (
                                            ...
                                            a: ({node, ...props}) => <a className="text-indigo-500 hover:underline hover:text-indigo-700" target="_blank" rel="noopener noreferrer" {...props} />,
                                            ...
                                            th: ({node, ...props}) => <th className="px-3 py-2 bg-slate-50 text-left text-xs font-bold text-slate-500 uppercase tracking-wider border-b border-slate-200" {...props} />,
